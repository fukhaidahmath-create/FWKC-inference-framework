...
This repository provides the full reproducible implementation of the FWKC (Finite-Sample Weighted Kappa Coefficient) agreement inference framework described in:
